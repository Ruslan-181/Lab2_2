...
int main() {
   ...
   // Встановлюємо CP1251 для консолі
    ...
    //цикл який викликає функції обчислень та виводить їх на консоль
    for (int i = 0; i < 4; i++) {
        int n = test_n[i];
    ...
    int n_l = 2;
    //нескінченний цикл працює і додає до змінної 2
    //поки модуль від різниці результата виконання функції більше за змінну eps
